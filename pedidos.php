...
$sql = "select p.id, p.total, p.fecha_pedido, p.estado,u.usuario_id,u.nombre AS usuario
        from pedidos p 
...
<body>
                ...
                if ($result->num_rows > 0) {
                    ...
                    <td>
                        <button class='btn btn-outline-primary btn-sm' 
                                ...
                                data-usuario_id='" . htmlspecialchars($row["usuario_id"]) . "'
                                data-total='" . htmlspecialchars($row["total"]) . "'
                                data-fecha_pedido='" . htmlspecialchars($row["fecha_pedido"]) . "'
    ...
    if ($result_usuarios === false) {
        echo "Error al obtener usuarios: " . $conexion->error;
        exit();
    }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="crudUsuarios/registrar.php" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="usuario" class="form-label">Usuarios</label>
                            <select class="form-select" name="usuario_id" id="usuario">
